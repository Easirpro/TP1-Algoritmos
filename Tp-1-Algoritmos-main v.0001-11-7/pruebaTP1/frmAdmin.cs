...
namespace pruebaTP1
{
    public partial class frmAdmin : Form
    {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtDni.Text.Length != 8 || txtTelefono.Text.Length < 7)
            {
                MessageBox.Show("El DNI y el Teléfono deben tener 8 dígitos al menos.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
